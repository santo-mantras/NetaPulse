                        ...
                        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-2">
                            <span className={`text-xs font-bold px-3 py-1 rounded-full border shadow-sm flex items-center gap-1.5 ${
                                candidate.role.toLowerCase().includes('prime minister')
                                    ...
                                    : candidate.role.toLowerCase().includes('leader of opposition') || candidate.role.toLowerCase().includes('lop')
                                    ? 'bg-rose-500/30 text-rose-200 border-rose-400/40 shadow-rose-500/10'
                                    : candidate.role.toLowerCase().includes('mp')
