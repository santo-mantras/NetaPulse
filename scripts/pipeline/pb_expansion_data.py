"""
Official Election Commission of India / Punjab Legislative Assembly complete constituency directory.
Covers all 23 districts and 117 Assembly Constituencies of Punjab.
"""

# Missing constituencies by district in Punjab to complete all 117 seats
PUNJAB_EXPANSION_DATA = [
    # Barnala District
    ...
    ("Hoshiarpur", "Garhshankar", "Garhshankar", "Deputy Speaker of Punjab Assembly", "Jai Krishan Singh Rouri", "Aam Aadmi Party", 2, "Graduate", 48000000, 3900000, 0, 94, 38, 50000000, 46500000),
